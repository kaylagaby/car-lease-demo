...
config.offlineUrl = 'http://localhost:3000';
config.appPort = (parseInt(process.env.PORT)) ? parseInt(process.env.PORT) : 3000;                         //Port that the NodeJS server is operating on
